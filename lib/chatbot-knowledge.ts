...
const conecta: KnowledgeEntry[] = [
  {
    ...
    title: "Conecta Bahia",
    content: "O Conecta Bahia é o programa de conectividade do estado, que instala pontos de internet gratuita em praças e espaços públicos dos municípios baianos. Os dados de cobertura são atualizados em tempo real e podem ser visualizados no Painel Conecta Bahia, um dos sistemas do Hub SECTI.",
    category: "conecta",
...
const geral: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    title: "Assistente Virtual do Hub SECTI",
    content: "O Hub SECTI possui um assistente virtual que pode fornecer informações sobre:\n\n• Sistemas disponíveis no hub\n• Projetos estratégicos (com dados ao vivo)\n• Conecta Bahia (estatísticas em tempo real)\n• Territórios da Bahia\n• Informações sobre a SECTI\n• Navegação no portal",
    category: "geral",
  },
  {
    id: "ajuda-topicos",
    keywords: ["ajuda", "socorro", "como usar", "o que posso perguntar", "menu", "opcoes", "topicos", "pode fazer"],
    title: "Tópicos disponíveis no Hub SECTI",
    content: "O Hub SECTI oferece informações sobre os seguintes tópicos:\n\n• Sistemas — 13 sistemas do hub organizados por categoria.\n• Projetos — Projetos cadastrados com dados ao vivo.\n• Conecta Bahia — Estatísticas de conectividade em tempo real.\n• Territórios — Os 27 territórios da Bahia.\n• SECTI — Sobre a secretaria, valores e missão.",
    category: "geral",
  },
  {
    id: "agradecimento",
    ...
    title: "Agradecimento",
    content: "O assistente virtual do Hub SECTI está disponível para ajudar com dúvidas sobre sistemas, projetos, conectividade, territórios e informações institucionais.",
    category: "geral",
  },
]
